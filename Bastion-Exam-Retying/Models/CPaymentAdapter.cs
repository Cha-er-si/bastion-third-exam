    ...
    internal sealed class CPaymentAdapter
    {
                ...
                if (bIsValid)
                {
                    ...
                    else
                    {
                        if (bIsValid)
                        {
                            ...
                            DateTime lExpiryDate = new DateTime(iYear, iMonth == 12 ? iMonth = 12 : iMonth + 1, 1);
        ...
        private void ProcessPayment(string[] pParameters)
        {
            try
            {
                ...
                if (lCommandStr == "FIELD=2&VALUE=6350123412341234;FIELD=14&VALUE=1223;FIELD=48&VALUE=789;")
                {
                    _result._returncode = "00";
                    _result._transactionid = "A877648";
                    _result._trandatetime = System.DateTime.Now.ToString("MMddyyyyHHmmss"); ;
                }
                else if (lCommandStr == "FIELD=2&VALUE=3566002020360505;FIELD=14&VALUE=1024;FIELD=48&VALUE=456;")
                {
